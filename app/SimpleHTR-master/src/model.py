...
class Model:
    ...
    def setup_ctc(self) -> None:
        ...
        # word beam search decoding (see https://github.com/githubharald/CTCWordBeamSearch)
            ...
            word_chars = open('C:/Users/install.PO-ETU007/Desktop/SimpleHTR/SimpleHTR-master/model/wordCharList.txt').read().splitlines()[0]
            corpus = open('C:/Users/install.PO-ETU007/Desktop/SimpleHTR/SimpleHTR-master/data/corpus.txt').read()
    ...
    def setup_tf(self) -> Tuple[tf.compat.v1.Session, tf.compat.v1.train.Saver]:
        ...
        model_dir = 'C:/Users/install.PO-ETU007/Desktop/SimpleHTR/SimpleHTR-master/model/'
    ...
    def dump_nn_output(rnn_output: np.ndarray) -> None:
        ...
        dump_dir = 'C:/Users/install.PO-ETU007/Desktop/SimpleHTR/SimpleHTR-master/dump/'
    ...
    def save(self) -> None:
        """Save model to file."""
        self.snap_ID += 1
        self.saver.save(self.sess, 'C:/Users/install.PO-ETU007/Desktop/SimpleHTR/SimpleHTR-master/model/snapshot', global_step=self.snap_ID)
